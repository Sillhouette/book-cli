...
describe(createDescribeHeader("Object-Oriented bookFetch.js"), function() {
  describe(createDescribeHeader("new BookFetch()"), function() {
    it(
      createItHeader(
        "creates a new BookFetch object with proper default settings"
      ),
      function() {
    ...
    it(
      createItHeader(
        "creates a new BookFetch object with custom max results setting"
      ),
      function() {
